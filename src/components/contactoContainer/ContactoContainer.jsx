            ...
            <div className='formulario-side-div col-12 col-md-7'>
                ...
                <div className='redes d-flex flex-column flex-md-row align-items-center my-5'>
                    ...
                    <div className='redesIconos mt-4 mt-md-0'>
                        <p><a target='_blank' rel="noreferrer"  href='https://www.facebook.com'><i class="fa-brands fa-facebook fa-2x"></i></a></p>
                        <p><a target='_blank' rel="noreferrer" href='https://www.instagram.com'><i class="fa-brands fa-instagram fa-2x ms-3"></i></a></p>
                    </div>
                </div>
            </div>
